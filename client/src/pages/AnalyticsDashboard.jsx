...
import { BarChart2, Users, FileText, CheckCircle, PlayCircle, Download, Activity, Clock } from 'lucide-react';
    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm h-96">
                <h3 className="font-bold text-gray-700 mb-4">Engagement Overview (Last 7 Days)</h3>
