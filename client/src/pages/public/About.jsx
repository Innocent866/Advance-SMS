    ...
    <div className="bg-milk overflow-hidden">
      ...
      <section className="relative py-20 lg:py-32 bg-white overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 filter contrast-125 brightness-100"></div>
         <div className="absolute top-0 right-0 w-1/2 h-full bg-hub-50/50 rounded-l-full blur-3xl transform translate-x-1/3 z-0"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
             ...
             >
                <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-extrabold text-gray-900 mb-6 tracking-tight">
                    About <span className="text-hub-600">GT-SchoolHub</span>
                </motion.h1>
                ...
                <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link to="/register-school">
                        <button className="px-8 py-4 rounded-full bg-hub-600 text-white font-bold text-lg shadow-lg hover:bg-hub-700 transition-all hover:-translate-y-1">
                            Get Started
                        </button>
                    </Link>
                    <Link to="/contact">
                         <button className="px-8 py-4 rounded-full bg-white text-hub-900 font-bold text-lg border border-hub-100 shadow-sm hover:bg-hub-50 transition-all flex items-center gap-2 justify-center">
             ...
             >
                  <div className="absolute inset-0 bg-hub-600 blur-[100px] opacity-10 rounded-full"></div>
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100 bg-white aspect-[16/9] md:aspect-[21/9] flex items-center justify-center">
                       {/* Placeholder for "Modern school technology or dashboard preview" */}
                        <div className="text-center p-8">
                            <Cpu size={64} className="text-hub-200 mx-auto mb-4" />
                         ...
                         <div className="absolute bottom-10 right-10 p-4 bg-hub-600 text-white rounded-xl shadow-lg">
                             <div className="flex items-center gap-3">
                                 <Users size={18} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="bg-white p-10 rounded-3xl shadow-sm border border-hub-50 hover:shadow-md transition-all group"
                  >
                      <div className="w-14 h-14 bg-hub-100 rounded-2xl flex items-center justify-center text-hub-600 mb-6 group-hover:scale-110 transition-transform">
                          <Lightbulb size={32} />
                      </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
           <div className="absolute top-0 left-0 w-full h-full bg-hub-900/5"></div>
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                   <motion.div
                       ...
                       viewport={{ once: true }}
                   >
                        <span className="text-hub-600 font-bold uppercase tracking-wider text-sm mb-2 block">Who We Are</span>
                   ...
                   <motion.div
                        ...
                        className="relative"
                   >
                        <div className="absolute -inset-4 bg-gradient-to-tr from-hub-600 to-hub-300 rounded-[2rem] opacity-20 blur-lg"></div>
                        <div className="relative h-[500px] w-full bg-gray-900 rounded-[2rem] overflow-hidden shadow-2xl flex items-center justify-center">
                             ...
                             <div className="absolute inset-0 bg-hub-900 opacity-60 z-10"></div>
                             <img 
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                   {[
                       ...
                       <motion.div
                          ...
                          className="bg-white p-8 rounded-2xl shadow-sm border border-hub-50 text-center hover:translate-y-[-5px] transition-all duration-300"
                       >
                           <div className="w-16 h-16 mx-auto bg-hub-50 rounded-full flex items-center justify-center text-hub-600 mb-6">
                               <item.icon size={28} />
                           </div>
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                   {[
                       ...
                       >
                           <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-hub-600 text-white flex items-center justify-center">
                               <feat.icon size={20} />
                           </div>
      ...
      {/* 6. Values Section */}
      <section className="py-24 bg-hub-900 text-white relative overflow-hidden">
           <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-10"></div>
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                     <h2 className="text-3xl font-bold">Our Core Values</h2>
                     <p className="mt-4 text-hub-200">The pillars that define our brand and promise.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    {[
                        ...
                        >
                            <val.icon size={32} className="mx-auto mb-4 text-hub-300" />
      ...
      <section className="py-24 bg-milk">
           <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
               <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-hub-50 relative overflow-hidden"
               >
                   <div className="absolute top-0 right-0 w-64 h-64 bg-hub-50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
                   
                   <div className="flex flex-col md:flex-row gap-10 items-center relative z-10">
                        <div className="w-48 h-48 md:w-64 md:h-64 flex-shrink-0 bg-gray-200 rounded-full overflow-hidden border-4 border-hub-100 shadow-lg">
                            <img src={founderImg} alt="Goldima Innocent" className="w-full h-full object-cover" />
                        </div>
                        <div className="text-center md:text-left">
                             <div className="inline-block px-4 py-1.5 rounded-full bg-hub-100 text-hub-700 text-sm font-bold mb-4">Founder Spotlight</div>
                             <h2 className="text-3xl font-bold text-gray-900 mb-2">Goldima Innocent</h2>
                             <p className="text-hub-600 font-medium mb-6">Founder, Goldima Tech</p>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <motion.div
                           ...
                           whileInView={{ opacity: 1 }}
                           viewport={{ once: true }}
                           className="bg-milk p-8 rounded-2xl border border-hub-50 relative"
                        >
                            <Quote size={40} className="text-hub-200 absolute top-6 right-6" />
                            <p className="text-gray-700 italic mb-6 relative z-10">"{t.quote}"</p>
                            <div className="font-bold text-hub-700">- {t.role}</div>
                        </motion.div>
                    ))}
               </div>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-hub-800 to-hub-600"></div>
          <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 filter contrast-125 brightness-100"></div>
          
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center text-white">
               <h2 className="text-4xl font-bold mb-6">Ready to Transform Your School?</h2>
               <p className="text-xl text-hub-100 mb-10">Join the Goldima Tech family and experience the future of school management today.</p>
               
               <div className="flex flex-col sm:flex-row gap-5 justify-center mb-12">
                   <Link to="/register-school">
                       <button className="w-full sm:w-auto px-10 py-4 rounded-full bg-white text-hub-900 font-bold text-lg shadow-xl hover:bg-gray-100 transition-all">
                           Create Free School Account
                       </button>
                   </Link>
                   <Link to="/contact">
                       <button className="w-full sm:w-auto px-10 py-4 rounded-full bg-transparent border-2 border-hub-200 text-white font-bold text-lg hover:bg-hub-700 transition-all">
                           Contact Us
                       </button>
                   </Link>
               </div>
               
               <div className="pt-10 border-t border-hub-500/30">
                    <p className="text-hub-200 font-medium">Get in touch directly:</p>
                    <a href="mailto:goldima@gt-schoolhub.com.ng" className="text-2xl font-bold text-white hover:text-hub-200 transition-colors mt-2 inline-block">
