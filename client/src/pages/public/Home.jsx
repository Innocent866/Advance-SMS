...
const Home = () => {
  return (
    <div className="overflow-hidden bg-milk">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <div className="animate-fadeInUp">
               <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-hub-50 text-hub-700 text-sm font-semibold mb-8 border border-hub-100 shadow-sm transition-all hover:bg-hub-100">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-hub-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-hub-500"></span>
                  </span>
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 mb-8 leading-[1.1] animate-fadeInUp animation-delay-200">
                ...
                <span className="text-hub-600">Intelligent Digital Tools</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center items-center animate-fadeInUp animation-delay-400">
                <Link to="/register-school" className="w-full sm:w-auto" aria-label="Register your school for free">
                    <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-hub-600 text-white font-bold text-lg shadow-xl hover:shadow-2xl hover:bg-hub-700 transition-all transform hover:-translate-y-1 border border-transparent">
                        Get Started Free
                    </button>
                </Link>
                <Link to="/contact" className="w-full sm:w-auto" aria-label="Request a demonstration of the platform">
                    <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-hub-900 font-bold text-lg border border-hub-100 shadow-md hover:bg-hub-50 hover:border-hub-200 transition-all flex items-center justify-center gap-2">
                        Request a Demo <ArrowRight size={20} className="text-hub-600" aria-hidden="true" />
                    </button>
                </Link>
              </div>
            </div>
          ...
          <div className="mt-20 relative group animate-fadeInUp animation-delay-400">
             <div className="absolute -inset-1 bg-gradient-to-r from-hub-500 to-hub-300 rounded-3xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
             <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-hub-100 bg-white transform hover:scale-[1.01] transition-transform duration-700">
                 {/* Abstract Dashboard UI */}
                 <div className="bg-milk aspect-[16/9] flex flex-col overflow-hidden">
                     {/* Top bar */}
                     <div className="h-14 bg-white border-b border-hub-50 flex items-center px-6 gap-4">
                         <div className="w-8 h-8 bg-hub-100 rounded-lg"></div>
                     ...
                     <div className="flex-1 flex overflow-hidden">
                         {/* Sidebar */}
                         <div className="w-64 bg-white border-r border-hub-50 p-6 hidden md:flex flex-col gap-4">
                             {[1, 2, 3, 4, 5].map(i => (
                                 <div key={i} className={`flex items-center gap-3 ${i === 1 ? 'bg-hub-50 p-2 rounded-lg' : ''}`}>
                                     <div className={`w-6 h-6 rounded-md ${i === 1 ? 'bg-hub-500' : 'bg-gray-100'}`}></div>
                                     <div className={`h-3 w-24 rounded-full ${i === 1 ? 'bg-hub-200' : 'bg-gray-100'}`}></div>
                                 </div>
                             ))}
                         </div>
                         {/* Main Content */}
                         <div className="flex-1 p-8 grid grid-cols-3 gap-6 bg-milk">
                              ...
                              <div className="col-span-3 lg:col-span-2 space-y-6">
                                  <div className="grid grid-cols-2 gap-6">
                                      <div className="h-32 bg-white rounded-xl shadow-sm border border-hub-50 p-4 relative overflow-hidden group/card" role="img" aria-label="Analytics visualization">
                                          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover/card:scale-110 transition-transform"><BarChart size={40} className="text-hub-600" aria-hidden="true" /></div>
                                          <div className="h-2 w-16 bg-hub-100 rounded mb-2"></div>
                                          <div className="h-8 w-24 bg-gray-800 rounded mb-2"></div>
                                      </div>
                                      <div className="h-32 bg-white rounded-xl shadow-sm border border-hub-50 p-4 relative overflow-hidden group/card" role="img" aria-label="User management visualization">
                                           <div className="absolute top-0 right-0 p-4 opacity-10 group-hover/card:scale-110 transition-transform"><Users size={40} className="text-hub-600" aria-hidden="true" /></div>
                                           <div className="h-2 w-16 bg-green-100 rounded mb-2"></div>
                                           <div className="h-8 w-24 bg-gray-800 rounded mb-2"></div>
                                      </div>
                                  </div>
                                  <div className="h-64 bg-white rounded-xl shadow-sm border border-hub-50 p-6">
                                      <div className="flex items-end gap-4 h-full pb-4">
                                          {[40, 60, 45, 75, 50, 80, 65, 90, 70].map((h, i) => (
                                              <div key={i} className="flex-1 bg-hub-50 rounded-t-lg relative group/bar">
                                                  <div style={{height: `${h}%`}} className="absolute bottom-0 w-full bg-hub-500 rounded-t-lg transition-all duration-1000 group-hover/bar:bg-hub-600"></div>
                                              </div>
                                          ))}
                                      </div>
                                  </div>
                              ...
                              <div className="col-span-3 lg:col-span-1 space-y-6">
                                  <div className="h-full bg-white rounded-xl shadow-sm border border-hub-50 p-6 flex flex-col gap-4">
                                      ...
                                      {[1, 2, 3, 4].map(i => (
                                          <div key={i} className="flex items-center gap-3">
                                              ...
                                              <div>
                                                  ...
                                                  <div className="h-2 w-12 bg-hub-50 rounded"></div>
                                              </div>
                                          </div>
                                      ))}
                                  </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden border-t border-hub-50">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                 <div className="animate-fadeInUp">
                     <h2 className="text-3xl font-bold sm:text-4xl mb-6 leading-tight text-gray-900">
                         Transforming Education Through <span className="text-hub-600">Technology</span>
                     </h2>
                     ...
                     <ul className="space-y-4">
                         {[
                             ...
                             <li key={i} className="flex items-center gap-3 text-lg font-medium text-gray-700">
                                 <div className="w-6 h-6 rounded-full bg-hub-100 flex items-center justify-center text-hub-600">
                                     <CheckCircle size={14} />
                                 </div>
                                 {item}
                             </li>
                 ...
                 <div className="relative animate-fadeInUp animation-delay-200">
                     <div className="grid grid-cols-2 gap-4">
                         <div className="space-y-4 mt-8">
                             <div className="bg-white p-6 rounded-2xl border border-hub-100 shadow-sm hover:shadow-md transition-all hover:scale-105">
                                 <Laptop className="text-hub-600 mb-4 h-8 w-8" />
                                 <h3 className="font-bold text-lg mb-2 text-gray-900">Smart Admin</h3>
                                 <p className="text-sm text-gray-500">View fees, automate attendance & admissions.</p>
                             </div>
                             <div className="bg-white p-6 rounded-2xl border border-hub-100 shadow-sm hover:shadow-md transition-all hover:scale-105">
                                 <BookOpen className="text-hub-500 mb-4 h-8 w-8" />
                         ...
                         <div className="space-y-4">
                             <div className="bg-white p-6 rounded-2xl border border-hub-100 shadow-sm hover:shadow-md transition-all hover:scale-105">
                                 <Users className="text-hub-600 mb-4 h-8 w-8" />
                             ...
                             <div className="bg-white p-6 rounded-2xl border border-hub-100 shadow-sm hover:shadow-md transition-all hover:scale-105">
                                 <BarChart className="text-hub-500 mb-4 h-8 w-8" />
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative text-center">
                   {[
                       ...
                       <div key={i} className="relative z-10 transition-transform hover:scale-105 duration-300">
                           <div className="w-24 h-24 mx-auto bg-white rounded-full border-4 border-hub-100 flex items-center justify-center text-2xl font-bold text-hub-600 mb-6 shadow-sm">
                               {item.step}
                           </div>
      ...
      {/* 7. Trust Signals */}
      <section className="py-16 bg-milk border-t border-hub-50">
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <div className="flex items-center gap-2 px-6 py-3 bg-white rounded-full shadow-sm text-sm font-medium text-gray-700 border border-hub-50">
      ...
      {/* 8. Final CTA */}
      <section className="py-24 bg-hub-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
              ...
              <p className="text-xl text-hub-100 mb-12 animate-fadeInUp animation-delay-200">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-5 animate-fadeInUp animation-delay-400">
                   <Link to="/register-school">
                        <button className="w-full sm:w-auto px-10 py-5 rounded-full bg-white text-hub-900 font-bold text-lg shadow-2xl hover:bg-gray-50 transition-all transform hover:scale-105 active:scale-95">
                            Create Free School Account
                        </button>
                   </Link>
                   <Link to="/contact">
                        <button className="w-full sm:w-auto px-10 py-5 rounded-full bg-transparent border border-hub-400 text-white font-bold text-lg hover:bg-hub-800 transition-all transform hover:scale-105 active:scale-95">
                            Contact Us
                        </button>
                   </Link>
              </div>
