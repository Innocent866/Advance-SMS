...
const ParentMaterials = () => {
    usePageTitle('Child Study Materials');
    ...
    const fetchMaterials = async () => {
        try {
            const response = await api.get('/parents/child-materials'); // Parent Endpoint
    ...
    const handleView = async (materialId, url) => {
        // Just open, no tracking needed for parent or maybe track as parent view
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 mb-8 text-white shadow-xl relative overflow-hidden">
                    <div className="relative z-10">
                        <h1 className="text-3xl font-bold mb-2">Child Study Library</h1>
                        <p className="text-indigo-100 mb-6 max-w-xl">View class notes, assignments, and worksheets assigned to your child.</p>
