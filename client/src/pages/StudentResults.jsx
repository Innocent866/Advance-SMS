...
const StudentResults = () => {
    ...
    // Calculate columns based on config or fallback to what's in results?
    // Better to use config if available, else derive?
    // Let's use config.components. If missing, show "No Config" or try to show keys from results?
    // Strict mode: Admin should have config.
    ...
    // Helper to get grade if not stored (e.g. preview)
    const getDisplayGrade = (result) => {
        // Priority 1: Calculate from Admin Config (Dynamic)
        // This ensures if Admin changes scale, students see updated grades immediately without re-saving
        ...
        // Priority 2: Stored Grade (Fallback)
        return result.grade || '-';
    };
        ...
        <div className="max-w-5xl mx-auto">
             <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">View your academic performance report.</p>
                </div>
            </div>
